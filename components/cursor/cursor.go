...
const _defaultBlinkSpeed = time.Millisecond * 530
...
// Model is the Tea model for this cursor element.
type Model struct {
...
func New() Model {
	return Model{
		...
		blinkCtx: time.NewTicker(_defaultBlinkSpeed),
	}
}
...
func (m *Model) CmdBlink() []tea.Cmd {
	...
	m.blinkCtx.Reset(_defaultBlinkSpeed)
