...
var DefaultKeyMap = KeyMap{
	...
	LineNext:                key.NewBinding([]string{"down", "ctrl+n"}),
	LinePrevious:            key.NewBinding([]string{"up", "ctrl+p"}),
	...
	InsertNewline:           key.NewBinding([]string{"enter", "ctrl+m"}),
	...
	InputBegin:              key.NewBinding([]string{"alt+<", "ctrl+home"}),
	InputEnd:                key.NewBinding([]string{"alt+>", "ctrl+end"}),

	CapitalizeWordForward: key.NewBinding([]string{"alt+c"}),
	LowercaseWordForward:  key.NewBinding([]string{"alt+l"}),
	UppercaseWordForward:  key.NewBinding([]string{"alt+u"}),

	TransposeCharacterBackward: key.NewBinding([]string{"ctrl+t"}),
}
