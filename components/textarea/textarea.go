...
var DefaultKeyMap = KeyMap{
	...
	LineNext:                key.Binding{Keys: []string{"down", "ctrl+n"}},
	LinePrevious:            key.Binding{Keys: []string{"up", "ctrl+p"}},
	...
	InsertNewline:           key.Binding{Keys: []string{"enter", "ctrl+m"}},
	...
	InputBegin:              key.Binding{Keys: []string{"alt+<", "ctrl+home"}},
	InputEnd:                key.Binding{Keys: []string{"alt+>", "ctrl+end"}},

	CapitalizeWordForward: key.Binding{Keys: []string{"alt+c"}},
	LowercaseWordForward:  key.Binding{Keys: []string{"alt+l"}},
	UppercaseWordForward:  key.Binding{Keys: []string{"alt+u"}},

	TransposeCharacterBackward: key.Binding{Keys: []string{"ctrl+t"}},
}
...
func (m *Model) Update(msg tea.Msg, f func(...tea.Cmd)) {
	...
	if (newRow != oldRow || newCol != oldCol) && m.Cursor.Mode() == cursor.ModeBlink {
