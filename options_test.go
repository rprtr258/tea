...
func TestOptions(t *testing.T) {
	...
	t.Run("input options", func(t *testing.T) {
		t.Run("tty input", func(t *testing.T) {
			p := NewProgram[*testModel](context.Background(), nil).WithInputTTY()
	...
	t.Run("startup options", func(t *testing.T) {
		...
		t.Run("without catch panics", func(t *testing.T) {
			p := NewProgram[*testModel](context.Background(), nil).WithoutCatchPanics()
			assert.True(t, p.startupOptions.has(withoutCatchPanics))
		})

		t.Run("without signal handler", func(t *testing.T) {
			p := NewProgram[*testModel](context.Background(), nil).WithoutSignalHandler()
			assert.True(t, p.startupOptions.has(withoutSignalHandler))
		})

		t.Run("mouse cell motion", func(t *testing.T) {
			p := NewProgram[*testModel](context.Background(), nil).WithMouseAllMotion().WithMouseCellMotion()
		...
		t.Run("mouse all motion", func(t *testing.T) {
			p := NewProgram[*testModel](context.Background(), nil).WithMouseCellMotion().WithMouseAllMotion()
	...
	t.Run("multiple", func(t *testing.T) {
		p := NewProgram[*testModel](context.Background(), nil).WithMouseAllMotion().WithAltScreen().WithInputTTY()
