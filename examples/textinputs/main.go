...
var (
	focusedStyle        = lipgloss.NewStyle().Foreground(lipgloss.FgColor("205"))
	blurredStyle        = lipgloss.NewStyle().Foreground(lipgloss.FgColor("240"))
	cursorStyle         = focusedStyle.Copy()
	noStyle             = lipgloss.NewStyle()
	helpStyle           = blurredStyle.Copy()
	cursorModeHelpStyle = lipgloss.NewStyle().Foreground(lipgloss.FgColor("244"))
